...
func (b *AcquireDriver) NewGameMergeTest() {
	bd := board.New()
	ts := tileset.New()
...
func (b *AcquireDriver) NewGameTiedMergeTest() {
	bd := board.New()
	ts := tileset.New()
	b.corporations = createCorporations()
	tiles := []interfaces.Tile{
...
func (b *AcquireDriver) NewGameMultiMergeTest() {
	bd := board.New()
	ts := tileset.New()
	b.corporations = createCorporations()
	tiles := []interfaces.Tile{
...
func (b *AcquireDriver) NewGameEndTest() {
	bd := board.New()
	ts := tileset.New()
	b.corporations = createCorporations()
	tiles := []interfaces.Tile{
...
func (b *AcquireDriver) NewGameAllCorpsOnBoardTest() {
