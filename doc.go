/*
Package main implements the driver interface, which allows to play Acquire games using the Sackson server.

Acquire accepted messages

These messages are the ones allowed by the Acquire driver and describe actions performed by players:
